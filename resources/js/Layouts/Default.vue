                                ...
                                >
                                    <svg class="h-5 w-5" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <circle fill="currentColor" fill-rule="nonzero" cx="7.94027149"
                                                    cy="3.51782805" r="1"></circle>
                                            <circle fill="currentColor" fill-rule="nonzero" cx="9.59457014"
                                                    cy="2.74352941" r="1"></circle>
                                            <circle fill="currentColor" fill-rule="nonzero" cx="6.91113122"
                                                    cy="5.00199095" r="1"></circle>
                                        </g>
                                    </svg>
                                </button>
