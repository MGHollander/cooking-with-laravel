...
const title = computed(() =>
  edit ? trans("recipes.form.edit_title", { title: props.recipe.title }) : trans("recipes.form.create_title"),
);
  ...
  <DefaultLayout>
    <template #header>
      ...
      <a
        ...
        :href="
          edit
            ? props.recipe.locale === 'nl'
              ? route('recipes.show.nl', props.recipe.slug)
              : route('recipes.show.en', props.recipe.slug)
            : ''
        "
        class="ml-4 text-sm"
