            ...
            <div id="ppms_cm_privacy_settings" data-editor-centralize="true" data-main-container="true"
                ...
                <div data-disable-select="true">
                    ...
                    <p id="ppms_cm_privacy_settings_form_link_text_id" class="mb-6">
                        Er worden gegevens verzameld om te analyseren hoe de website wordt gebruikt. Er wordt
                        altijd
                        toestemming
                        gevraagd om dit te doen. Je kunt uw privacy-instellingen hier wijzigen.
                    </p>
                    <button
        ...
        <div class="mt-8 w-full overflow-hidden bg-white p-8 shadow-md sm:max-w-2xl sm:rounded-lg">
            <div id='ppms_cm_data_subject' class='ppms_cm_data_subject_widget__wrapper' data-editor-centralize='true'
                ...
                <p id='ppms_cm_data_subject_paragraph' class='paragraph'>
                    Vul het formulier in om toegang tot uw gegevens te vragen. We zullen uw e-mailadres alleen gebruiken
